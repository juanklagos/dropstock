        ...
        <div class="ihc-popup-content" style="text-align: center;">
        	<div style="margin: 0 auto; display: inline-block;">
	            ...
	            <div class="ihc-popup-shortcodevalue" onClick="tinymce.execCommand('ihc_return_text', '[ihc-select-level]');"><i class="fa-ihc fa-user-plus-ihc"></i><?php _e('Subscription Plan', 'ihc');?></div>
							...
							<div class="ihc-popup-shortcodevalue" onClick="tinymce.execCommand('ihc_return_text', '[ihc-login-popup]<?php _e( 'Login', 'ihc' );?>[/ihc-login-popup]');"><i class="fa-ihc fa-sign-in-ihc"></i><?php _e('Login Modal', 'ihc');?></div>
							<div class="ihc-popup-shortcodevalue" onClick="tinymce.execCommand('ihc_return_text', '[ihc-register-popup]<?php _e( 'Register', 'ihc' );?>[/ihc-register-popup]');"><i class="fa-ihc fa-user-plus-ihc"></i><?php _e('Register Modal', 'ihc');?></div>

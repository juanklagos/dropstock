...
<?php if ($levels):?>
    ...
    line-height: 1.4;">
		...
		<?php foreach ($levels as $id => $level):?>
			<tr>
				<td style="vertical-align: middle;"><span  class="ihc-list-affiliates-name-label"><?php echo $level['label'];?></span></td>
				...
				<td style="vertical-align: middle;">
					<input type="text" class="form-control" onclick="openMediaUp(this, '<?php echo '#img_level' . $id;?>');" value="<?php echo $level['badge_image_url'];?>" name="<?php echo "badge_image_url[$id]";?>" id="<?php echo 'badge_image_url'.$id;?>" style="width: 90%;display: inline; float:none; min-width:500px;">

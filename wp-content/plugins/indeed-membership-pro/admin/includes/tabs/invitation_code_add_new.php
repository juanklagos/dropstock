						...
						<?php
							if (!empty($_GET['multiple'])){
								...
								<div class="iump-form-line">
									...
									<input type="text" value="" name="code" id="ihc_the_coupon_code" /> <span style="font-size: 11px;color: #fff; padding: 6px 9px;-webkit-border-radius: 3px;box-radius: 3px;    background-color: rgba(240, 80, 80, 0.8);cursor: pointer;" onClick="ihcGenerateCode('#ihc_the_coupon_code', 10);"><?php _e("Generate Code", "ihc");?></span>
								</div>
								<?php
							}
						?>

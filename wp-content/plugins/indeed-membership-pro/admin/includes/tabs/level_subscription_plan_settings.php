				...
				<div class="inside">
					...
					<div class="iump-form-line">
						...
						<div>
							...
							<input type="checkbox" <?php echo $checked;?> onClick="ihcMakeInputhString(this, 'unreg', '<?php echo '#level' . $id . 'cond';?>');" /><span style="font-weight:bold; vertical-align:bottom;"> <?php _e('UnRegistered Users', 'ihc');?></span>
						</div>
						<div>
							<?php $checked = (in_array('no_pay', $hidden_arr)) ? 'checked' : '';?>
							<input type="checkbox" <?php echo $checked;?> onClick="ihcMakeInputhString(this, 'no_pay', '<?php echo '#level' . $id . 'cond';?>');" /><span style="font-weight:bold; vertical-align:bottom;"> <?php _e('Registered Users with no payment made', 'ihc');?></span>
						</div>
						...
						<?php foreach ($levels as $lid=>$larr):?>
							...
							<div style="margin: 0px 4px; margin-right:12px; display: inline-block; vertical-align: top; font-weight:bold;">
								...
								<input type="checkbox" <?php echo $checked;?> onClick="ihcMakeInputhString(this, '<?php echo $lid;?>', '<?php echo '#level' . $id . 'cond';?>');" /> <span style="vertical-align: bottom;" class="<?php echo $spanclass;?>"><?php echo $larr['label'];?></span>
							</div>
						<?php endforeach;?>

	...
	Croppic.prototype = {
      ...
      var formHtml = '<form class="' + that.id + '_imgUploadForm" style="visibility: hidden;">  <input type="file" name="img" id="' + that.id + '_imgUploadField">  </form>';
		...
		createModal: function(){
			...
			var modalHTML =  '<div id="croppicModal">'+'<div id="croppicModalObj" class="ihc-cst-croppic" style="width:'+ that.objW +'px; height:'+ that.objH +'px; margin:0 auto; margin-top:'+ marginTop +'px; position: relative; max-width:100%;"> </div>'+'</div>';
